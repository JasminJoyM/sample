...
class Our_Testimonial_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'heritaste_our_testimonial_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonial V3', 'heritaste' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_testimonial_v3',
			[
				'label' => esc_html__( 'Our Testimonial V3', 'heritaste' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your Sub Text', 'heritaste' ),
			]
		);
		$this->add_control(
			'text_limit',
    ...
    <section class="testimonial-style-three sec-pad centred">
        ...
        <div class="auto-container">
            ...
            <div class="two-item-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                ...
                <div class="testimonial-block-three">
                    ...
                    <div class="inner-box">
                        <div class="quote-1"><i class="flaticon-double-quotes"></i></div>
                        <div class="quote-2"><i class="flaticon-double-quotes"></i></div>
                        <div class="text">
