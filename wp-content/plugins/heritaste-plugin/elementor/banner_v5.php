...
class Banner_V5 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner V5', 'heritaste' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'banner_v5',
            [
                'label' => esc_html__( 'Banner V5', 'heritaste' ),
            ]
        );
		$this->add_control(
			'slides', 
			[
				...
				'default' => 
					[
						['title' => esc_html__('Food, Folks & Fun all together in Heritaste', 'heritaste')],
						['title' => esc_html__('Best food, made by our passioante chefs', 'heritaste')],
						['title' => esc_html__('Deliciousness jumping into the mouth', 'heritaste')],
					],
				'fields' => 
				[
					[
            ...
            <div class="slide-item <?php if($item['style_two'] == 'two') echo 'style-two'; else echo ''; ?>">
                ...
                <div class="auto-container">
                    <div class="content-box">
                        <span class="special-font"><?php echo wp_kses($item['sub_title'], true); ?></span>
