 ...
 * @since 1.0.0
 */
class Booking_Form_V3 extends Widget_Base {
    ...
    public function get_name() {
        return 'heritaste_booking_form_v3';
    }
    ...
    public function get_title() {
        return esc_html__( 'Booking Form V3', 'heritaste' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'booking_form_v3',
            [
                'label' => esc_html__( 'Booking Form V3', 'heritaste' ),
            ]
        );
		$this->add_control(
			'bg_image',
    ...
    <!-- booking-style-two -->
    <section class="booking-style-two alternat-2">
