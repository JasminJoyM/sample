 ...
 * @since 1.0.0
 */
class Our_Gallery_V7 extends Widget_Base {
	...
	public function get_name() {
		return 'heritaste_our_gallery_v7';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V7', 'heritaste' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_gallery_v7',
			[
				'label' => esc_html__( 'Our Gallery V7', 'heritaste' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <div class="masonry-item <?php if(get_post_meta( get_the_id(), 'gallery_dimension', true) == 'extra_width') echo 'col-lg-6 col-md-6 col-sm-12 big-column'; elseif(get_post_meta( get_the_id(), 'gallery_dimension', true) == 'extra_height') echo 'col-lg-3 col-md-6 col-sm-12 small-column'; else echo 'col-lg-3 col-md-6 col-sm-12 small-column'?> all <?php echo esc_attr($term_slug); ?>">
                        ...
                        <figure class="image-box">
							<?php 
								...
								if($dimention == 'extra_width'){
									$image_size = 'heritaste_570x300';
								} elseif($dimention == 'extra_height'){
									$image_size = 'heritaste_270x630';
								} else{
									$image_size = 'heritaste_270x300'; 
								}
