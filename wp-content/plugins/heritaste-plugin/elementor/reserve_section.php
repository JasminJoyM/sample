 ...
 * @since 1.0.0
 */
class Reserve_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'heritaste_reserve_section';
    }
    ...
    public function get_title() {
        return esc_html__( 'Reserve Section', 'heritaste' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'reserve_section',
            [
                'label' => esc_html__( 'Reserve Section', 'heritaste' ),
            ]
        );
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			'phone_title',
			[
				'label'       => __( 'Phone Title', 'heritaste' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Phone Title', 'heritaste' ),
			]
		);
		$this->add_control(
			'phone_no',
			[
				'label'       => __( 'Phone Number', 'heritaste' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Phone Number', 'heritaste' ),
			]
		);
		$this->add_control(
			'btn_title',
                ...
                <div class="row clearfix">
                    <div class="col-xl-5 col-lg-12 col-md-12 content-column">
                        <div class="content-box">
                            ...
                            <div class="light-icon"><i class="flaticon-restaurant"></i></div>
                            <div class="text">
                            ...
                            <div class="support-box">
                                <div class="icon-box"><i class="flaticon-dial-pad-1"></i></div>
                                <?php if($settings['phone_title']) { ?><h6><?php echo wp_kses($settings['phone_title'], true);?></h6><?php } ?>
                                <?php if($settings['phone_no']) { ?><h3><a href="tel:<?php echo esc_attr($settings['phone_no']); ?>"><?php echo wp_kses($settings['phone_no'], true);?></a></h3><?php } ?>
                            </div>
                            <?php } ?>
