...
class Our_Gallery_V6 extends Widget_Base {
	...
	public function get_name() {
		return 'heritaste_our_gallery_v6';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V6', 'heritaste' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_gallery_v6',
			[
				'label' => esc_html__( 'Our Gallery V6', 'heritaste' ),
			]
		);
		$this->add_control(
			'number',
		...
		<?php 
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                <div class="gallery-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><?php the_post_thumbnail('heritaste_422x422'); ?></figure>
                        <div class="content-box">
                            <div class="shape" style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape-71.png);"></div>
                            <div class="inner">
                                <div class="view-btn">
            ...
            <section class="gallery-four-columns sec-pad centred">
