...
class Our_Gallery_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'heritaste_our_gallery_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V3', 'heritaste' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_gallery_v3',
			[
				'label' => esc_html__( 'Our Gallery V3', 'heritaste' ),
			]
		);
		$this->add_control(
			'query_number',
        ...
        <div class="outer-container">
            <div class="gallery-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                ...
                <div class="gallery-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><?php the_post_thumbnail('heritaste_480x480'); ?></figure>
                        <div class="content-box">
                            <div class="shape" style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape-43.png);"></div>
                            <div class="inner">
                                <div class="view-btn">
