...
class Our_Gallery_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'heritaste_our_gallery_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Gallery V4', 'heritaste' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'our_gallery_v4',
			[
				'label' => esc_html__( 'Our Gallery V4', 'heritaste' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
           ...
           <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                <div class="gallery-block-one">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            <div class="shape" style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape-70.png);"></div>
                            <div class="inner">
                                <div class="view-btn">
            ...
            <!-- gallery-two-columns -->
            <section class="gallery-two-columns sec-pad centred">
