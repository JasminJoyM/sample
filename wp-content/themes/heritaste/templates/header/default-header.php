...
<div class="boxed_wrapper">
    ...
    <header class="main-header">
        ...
        <div class="header-top">
            <div class="top-inner">
                <?php if($options->get('welcome_title_v1')){ ?><div class="text"><p><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/icon-1.png" alt="<?php esc_attr_e('Awesome Image', 'fico'); ?>"><?php echo wp_kses($options->get('welcome_title_v1'), true); ?></p></div><?php } ?>
                <?php if($options->get('order_text_v1')){ ?><div class="text"><p><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/icon-1.png" alt="<?php esc_attr_e('Awesome Image', 'fico'); ?>"><a href="<?php echo esc_url($options->get('text_link_v1')); ?>"><?php echo wp_kses($options->get('order_text_v1'), true); ?></a></p></div><?php } ?>
                <?php if($options->get('our_address_v1')){ ?><div class="text"><p><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icons/icon-1.png" alt="<?php esc_attr_e('Awesome Image', 'fico'); ?>"><?php echo wp_kses($options->get('our_address_v1'), true); ?></p></div><?php } ?>
            </div>
        </div>
        <?php } ?>
        <!-- header-lower -->
            ...
            <div class="outer-box">
                ...
                <div class="menu-right">
                    <ul class="info">
                        ...
                        <?php } ?>
                        <?php 
							if( $options->get('show_cart_icon_v1') ){
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            ...
            <div class="contact-info">
                <?php if($options->get('contact_title_v1')){ ?><h4><?php echo wp_kses($options->get('contact_title_v1'), true); ?></h4><?php } ?>
                <ul>
                    <?php if($options->get('address_v1')){ ?><li><?php echo wp_kses($options->get('address_v1'), true); ?></li><?php } ?>
                    <?php if($options->get('contact_no_v1')){ ?><li><a href="tel:<?php echo esc_attr($options->get('contact_no_v1')); ?>"><?php echo wp_kses($options->get('contact_no_v1'), true); ?></a></li><?php } ?>
                    <?php if($options->get('our_email')){ ?><li><a href="mailto:<?php echo esc_attr($options->get('our_email')); ?>"><?php echo wp_kses($options->get('our_email'), true); ?></a></li><?php } ?>
                </ul>
            </div>
