...
get_header();
global $wp_query;
$data  = \HERITASTE\Includes\Classes\Common::instance()->data( 'search' )->get();
        ...
        <div class="row clearfix">
            ...
            <div class="content-side <?php echo esc_attr( $class ); ?>">
                <div class="blog-classic-content">
                    ...
                    <?php else : ?>
                        <div class="blog-sidebar p-0 default-sidebar">
                            <p class="mb-4"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'heritaste' ); ?></p>
                            <?php get_search_form() ?>
                        </div>
                    <?php endif; ?>
