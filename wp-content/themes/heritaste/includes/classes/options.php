...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'heritaste' . '_options';
	...
	private $page_slug = 'heritaste' . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'HERITASTE Options', 'heritaste' );
		$this->page_title = esc_html__( 'HERITASTE Options', 'heritaste' );
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'heritaste_options',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'heritaste' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'heritaste' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'heritaste' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'heritaste' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'heritaste' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'heritaste_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "heritaste_redux_sections_{$key}", $options );
